...
// Inicializa a variável para armazenar os índices das linhas vencedoras
$winningIndices = [];
...
// Function to map numbers to images
function getImageForNumber($number) {
    return "imagens/symbol{$number}.png"; // Adjust the path to your images folder
}
?>
