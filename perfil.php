...
<head>
    ...
    <style>
        body {
            ...
            background-image: url('assets/onca5.png');
	    ...
	    top: 4%;
            margin: 30px auto;
            background-color: rgba(0, 0, 0, 0.8); /* Fundo escuro para contrastar com o verde */
            padding: 20px;
            border-radius: 10px;
...
<body>
 ...
 <div class="container">
    ...
    <a style='color: #03300B; background-color: whitesmoke; padding:10px; border-radius: 20px' href="dashboard.php">Voltar ao Dashboard</a>
	<br> <br>
 </div>
